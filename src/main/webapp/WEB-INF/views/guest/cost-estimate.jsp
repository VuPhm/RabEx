...
<!-- Header Start-->
<div class="bg-primary container-fluid pb-3 pt-5 wow slideInDown" style="margin-bottom: 35px; visibility: visible; animation-name: slideInDown;">
    <div class="container">
    ...
    <div class="container py-3 px-5 service-item">
        <form>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="py-3" for="receiverAddress">* Địa chỉ người nhận:</label>
                        <select id="receiverAddress" class="form-control bg-light">
                            <option selected>Chọn tỉnh/thành phố</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group py-3">
                        ...
                        <div class="input-group">
                            <input type="text" id="weight" class="form-control" placeholder="Vui lòng nhập thông tin">
...
<div id="cost_estimate_result" class="container-xxl wow fadeIn">
    <div class="container py-5 px-5 service-item">
        <h5 class="text-center">Phí vận chuyển ước tính sẽ bao gồm phụ phí và trừ đi các khoản chiến khấu/giảm giá bởi khuyến mãi.</h5>
